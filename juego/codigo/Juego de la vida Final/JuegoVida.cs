...
namespace Juego_de_la_vida
{
    ...
    public class JuegoVida
    {
        ...
        private MyEventHandler controEventos; 
        #endregion
        ...
        {
            controEventos = new MyEventHandler(OnFireUpdate);
        ...
        public void Jugar()
        {
            ...
            while (!@stop)
            {
                ...
                controEventos.Invoke(nacen, mueren);
                System.Threading.Thread.Sleep(15);//1 es el mejor valor aqui xD
            }
        } 
        #endregion
    }
